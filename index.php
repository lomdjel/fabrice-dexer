			...
			<div class="col-md-3" style="background-color: #F0F0F0;border-radius: 5px;margin-top: 2.5%;height: 1410px;">
		  	...
		  	<div class="col-md-9">
		        ...
		        <div class="what-we-do">
		            <div class="container-fluid">
		            <div class="row">
		                <div class="service col-md-4 col-md-4-bis">
		                    <div class="icon-awesome">
		                        <i class="icon-eye-open"></i>
		                    </div>
		                    <h4>Type de Déméngament</h4>
		                ...
		                <div class="service col-md-4 col-md-4-bis">
		                    ...
		                    <h4>Comment on fait?</h4>
		                    <p>Etape par étape - Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et...</p>
		                    <a href="services.html">Read more</a>
		                </div>
		                <div class="service col-md-4 col-md-4-bis">
		                    <div class="icon-awesome">
		        ...
		        <div class="row">
				  <div class="col-xs-6">
				  	...
				  	<div class="service-bis">
	                    ...
	                    <h4>Nouvelles de l'entreprise</h4>
	                    <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et...</p>
	                    <ul>
